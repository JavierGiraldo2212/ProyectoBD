...
public class UseEmpresa extends JPanel {
        ...
        public UseEmpresa(JPanel cardPanel, UsersSesions userF) {
                ...
                groupLayout.setHorizontalGroup(
                                groupLayout.createParallelGroup(Alignment.LEADING)
                                                .addGroup(groupLayout.createSequentialGroup()
                                                                ...
                                                                .addComponent(panelAux, GroupLayout.DEFAULT_SIZE, 1035,
                                                                                Short.MAX_VALUE)
                                                                .addContainerGap()));
                ...
                // Group layout for the auxiliary panel
                ...
                gl_panelAux.setHorizontalGroup(
                                gl_panelAux.createParallelGroup(Alignment.LEADING)
                                                .addGroup(gl_panelAux.createSequentialGroup()
                                                                ...
                                                                .addComponent(Titulo, GroupLayout.PREFERRED_SIZE, 518,
                ...
                btnLogout.setIcon(new ImageIcon(UseEmpresa.class.getResource("/images/logout.png")));
                btnLogout.setBackground(Color.WHITE);

                // Group layout for the lateral panel
                ...
                gl_panelLateral.setVerticalGroup(
                                gl_panelLateral.createParallelGroup(Alignment.LEADING)
                                                .addGroup(gl_panelLateral.createSequentialGroup()
                                                                ...
                                                                .addGap(245)
                                                                .addComponent(btnBack)
                                                                .addPreferredGap(ComponentPlacement.RELATED, 316,
                                                                                Short.MAX_VALUE)
                                                                .addComponent(btnLogout)
                                                                .addContainerGap()));
