...
CREATE TABLE IF NOT EXISTS Proyecto_BD.OFERTA_LABORAL (
  No_oferta INT NOT NULL COMMENT 'Representa la llave primaria de la entidad Oferta_laboral. Artificial',
...
CREATE TABLE IF NOT EXISTS Proyecto_BD.EQUIPO (
  ID INT NOT NULL COMMENT 'Representa la llave primaria de la entidad EQUIPOS de tipo numerico',
...
CREATE TABLE IF NOT EXISTS Proyecto_BD.EXPERIENCIA_LABORAL (
  ...
  ID INT NOT NULL COMMENT 'Representa la llave primaria de la entidad EXPERIENCIA_LABOPRAL de tipo numerico',
