...
SHOW GRANTS FOR Empresa;
SHOW GRANTS FOR 'carlos.rodriguez.E'@'localhost' ;

CREATE USER 'Estudiante_prueba'@'localhost' IDENTIFIED BY '12345';
GRANT SELECT ON sede TO 'Estudiante_prueba'@'localhost';
GRANT SELECT ON facultad TO 'Estudiante_prueba'@'localhost';
GRANT SELECT ON equipo TO 'Estudiante_prueba'@'localhost';
GRANT SELECT ON eventos TO 'Estudiante_prueba'@'localhost';
SHOW GRANTS FOR 'Estudiante_prueba'@'localhost' ;
